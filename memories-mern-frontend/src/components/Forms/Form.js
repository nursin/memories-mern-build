...
function Form({ currentId, setCurrentId }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (currentId) {
            ...
            dispatch(createPost({...postData, name: user?.result?.name, creator: currentId}));
        }
        clear();
    }
    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete='off' noValidate={`${classes.root}, ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <Button variant="container" color="blue" size="large" type="submit" fullWidth>Submit</Button>
